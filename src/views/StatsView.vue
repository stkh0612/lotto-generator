    ...
    <div class="subpage-container">
      ...
      <v-row class="mb-8">
        ...
        <v-col cols="12" md="6">
          <div class="clean-card pa-6 fill-height">
            ...
            <p class="card-inner-sub mb-4">과거 누적 빈도가 낮았던 번호입니다. 다음 회차 출현 확률은 다른 번호와 동일합니다.</p>
            <div style="height: 280px;">
      ...
      <div class="clean-card pa-6 text-left mb-8">
        ...
        <div class="text-body-2 text-grey-darken-1" style="line-height: 1.8;">
          ...
          <p class="mb-3">
            <strong>대수의 법칙과 조합 확률의 원리:</strong> 장기적으로 각 숫자는 전체 추출 번호에서 약 <code>1/45 (약 2.22%)</code>의 동일한 비중을 차지하게 됩니다. 한 회차에서 특정 숫자가 6개 당첨번호에 포함될 확률은 <code>6/45 (약 13.33%)</code>입니다. 과거의 누적 출현 편차와 무관하게 다음 회차에서 각 번호가 추첨될 확률은 완벽히 동일하며, 통계 데이터는 번호 선택 시 극단적인 쏠림을 피하고 균형을 조율하는 참고 자료로 활용할 수 있습니다.
          </p>
          <p class="mb-0">
